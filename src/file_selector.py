...
class FileSelector(wx.Frame):
    ...
    def OnSelectFiles(self, event):
        ...
        with wx.FileDialog(self, "Select Files", defaultDir=default_dir, wildcard="*.*", style=wx.FD_OPEN | wx.FD_MULTIPLE) as fileDialog:
            if fileDialog.ShowModal() == wx.ID_OK:
                ...
                self.configuration_manager.save_config(self.configuration_manager.project_config_file, project_config)
