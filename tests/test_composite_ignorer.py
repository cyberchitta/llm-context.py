import unittest
from src.composite_ignorer import CompositeIgnorer


class TestCompositeIgnorer(unittest.TestCase):
    def test_simple_filename(self):
        ignorer = CompositeIgnorer.create(["*.txt"])
        self.assertTrue(ignorer.ignore("file.txt", False))
        self.assertFalse(ignorer.ignore("file.py", False))

    def test_directory_pattern(self):
        ignorer = CompositeIgnorer.create(["dir/"])
        self.assertTrue(ignorer.ignore("dir", True))

    def test_negation(self):
        ignorer = CompositeIgnorer.create(["*.txt", "!important.txt"])
        self.assertTrue(ignorer.ignore("file.txt", False))
        self.assertFalse(ignorer.ignore("important.txt", False))

    def test_root_directory_pattern(self):
        ignorer = CompositeIgnorer.create(["/root"])
    ...
    def test_nested_directory_pattern(self):
        ignorer = CompositeIgnorer.create(["**/logs"])
    ...
    def test_complex_pattern(self):
        ignorer = CompositeIgnorer.create(["*.py[cod]"])
    ...
    def test_comment_and_empty_lines(self):
        ignorer = CompositeIgnorer.create(["# This is a comment", "", "*.txt"])
        self.assertTrue(ignorer.ignore("file.txt", False))
        self.assertFalse(ignorer.ignore("# This is a comment", False))

    def test_multiple_directory_pattern(self):
        ignorer = CompositeIgnorer.create(["/priv/static"])
    ...
    def test_multiple_directory_pattern_with_wildcard(self):
        ignorer = CompositeIgnorer.create(["docs/**/secret"])
    ...
    def test_single_asterisk(self):
        ignorer = CompositeIgnorer.create(["*.log"])
    ...
    def test_double_asterisk(self):
        ignorer = CompositeIgnorer.create(["**/node_modules"])
    ...
    def test_question_mark(self):
        ignorer = CompositeIgnorer.create(["file?.txt"])
    ...
    def test_character_class(self):
        ignorer = CompositeIgnorer.create(["file[0-9].txt"])
    ...
    def test_negation_with_wildcard(self):
        ignorer = CompositeIgnorer.create(["*.log", "!important.log"])
