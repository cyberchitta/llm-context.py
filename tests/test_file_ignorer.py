...
class TestFileIgnorer(unittest.TestCase):
    ...
    def test_multiple_directory_pattern_with_wildcard(self):
        ignorer = FileIgnorer(["docs/**/secret"])
    ...
    def test_double_asterisk(self):
        ignorer = FileIgnorer(["**/node_modules"])
    ...
    def test_character_class(self):
        ignorer = FileIgnorer(["file[0-9].txt"])
    ...
    def test_negation_with_wildcard(self):
        ignorer = FileIgnorer(["*.log", "!important.log"])
